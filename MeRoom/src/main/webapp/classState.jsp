         ...
         <tbody>
            <tr class="item content">
              <td class="item img"><img src="/upload/${oneList.oImg }"  width="100" height="100"></td>
               ...
               <td class="item total">${pay.opMoney }원</td>
               <td class="item cancel"><button class="btn" onclick="location.href='rsvRefund.do?orIdx=${oneList.orIdx}&orfMoney=${oneList.opMoney }'">예약취소</button></td>
