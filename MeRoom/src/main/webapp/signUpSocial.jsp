...
<%@ include file="mainheader.jsp" %>
 ...
 <div id="wrap">
	...
	<form id="form1" action="signUpSocial.do" method="post" >
		<div class="h2-Text">
			<strong>추가 정보를 입력해주시면 가입이 완료됩니다.</strong>
		</div>
		<table class="tb_main">
			<colgroup>
			...
			<tbody>
				 <tr>
                    ...
                    <td>
                        ...
                        placeholder="이름을 입력해 주세요" value="${rvo.name }"  required>
                    </td>
                 </tr>
                  <tr>
                    <th>
                    ...
                    <td>
                        ...
                        placeholder="이름을 입력해 주세요" value="${rvo.nickname }" required>
                    </td>
                 </tr>
				...
				<tr>
				 ...
				 <tr>
                    ...
                    <td>
                        ...
                        <select id="emailBox" name="emailBox" class="input--text name">
			...
			<div class="btngroups">
				 ...
				 <input type="hidden" name="memberId" value="${rvo.memberId }">
