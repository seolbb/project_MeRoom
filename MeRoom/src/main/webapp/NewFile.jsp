...
<body>
			    ...
			    <div class="rvinfo">
			        ...
			        <div class="bar">
						...
						<div class="cnt">
						    ...
						    <input type="number" class="numBox" max="" name="orCount" value="0" readonly="readonly"/>
	...
	function changeCnt(cnt){
		...
		$(".plus").click(function(){
			...
			let possibleCnt = oCnt - cnt;
			console.log("oCnt" + oCnt);
			console.log("cnt" + cnt);
			console.log("possibleCnt" + possibleCnt);
			if(plusNum > possibleCnt) {
				$(".numBox").val(num);
				$('input[name=orCount]').attr('max',possibleCnt);
			} else {
				$(".numBox").val(plusNum);          
