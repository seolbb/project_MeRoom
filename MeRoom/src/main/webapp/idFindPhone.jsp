	    ...
	    <div class="wrap" >
            <div id="cont1">
                ...
                <div class="panel-body">
                	<div class="subGroup">
                	<button id="mal" class="tablink" onclick="location.href='idFindMail.jsp'" id="defaultOpen">Email</button>
					<button id="ph" class="tablink" onclick="location.href='idFindPhone.jsp'" id="phoneOpen">Phone</button>  
                	</div>
                	<br><br><br>
                    ...
                    <div class="inner">
                        <div class="container3">
                            <div class="popup-content">
                                ...
                                <div class="buttons">
                                    <button class="button reser payment" onclick="location.href='login.jsp'">로그인</button>
                                    <button class="button reser clear" onclick="location.href='pwFindMail.jsp'">비밀번호 찾기</button>
                                </div>
