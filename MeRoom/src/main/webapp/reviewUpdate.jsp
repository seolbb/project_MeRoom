...
<body>
<div class="container">
<form name="writeRv" method="post" action="reviewUpdate.do" target="parentPage2">
	<div class="head">
	...
	<div class="content">
		...
		<div class="textbox">
			<textarea name="rv_content" class="tbox" placeholder="최소 10자 이상 입력해주세요" required>${rvo.rv_content }</textarea>
		</div>
	</div>
	<div class="btngroups">
		<button class="btn cancel" onclick="window.close()">취소</button>
		<button type="submit" id="in" class="btn input" onclick="window.close()">수정</button>
		<input type="hidden" id="rv" name="rv_idx" value="${rvo.rv_idx }">
	</div>
</form>
</div>
