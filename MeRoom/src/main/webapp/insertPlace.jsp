	...
	<div style="width: 60%; margin: auto;">
		<form action="insertPlace.do" method="post"
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="label" name="ptitle" required="required">
			</div>
			<div class="form-group">
				<label for="label">시간</label>
				<input type="text" class="form-control" id="label" name="ptime">
			</div>
			<div class="form-group">
				<label for="label">전화번호</label>
				<input type="text" class="form-control" id="label" name="pphone">
			</div>
			<div class="form-group">
				<label for="label">위치</label>
				<input type="text" class="form-control" id="label" name="plocation">
			</div>
			<div class="form-group">
...
<!-- <!-- 					<img src="display.do?fileName=bizarim3.jpg"> --> 
<!-- <!-- 				</div> --> 
<!-- 			</div> -->
<!-- 			<!-- multiple="multiple"  <- 파일 복수로 저장--> 
<!-- 		</div> -->
<!-- 	</div> -->
...
// 			formData.append("uploadFile", fileList[i]);  // 파일이 여러개일때
// 		}
