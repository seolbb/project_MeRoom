...
function back() {
	location.href="/mr/getEnjoyListAdmin.do"
}
function setValue() {
	$("select option[value='${enjoy.ecategory}']").attr('selected', true);
	$('input[name=etitle]').attr('value', '${enjoy.etitle}');
	$('input[name=etext]').attr('value', '${enjoy.etext}');
	$('input[name=ephone]').attr('value', '${enjoy.ephone}');
	$('input[name=elocation]').attr('value', '${enjoy.elocation}');
	$('input[name=eprice]').attr('value', '${enjoy.eprice}');
	$('input[name=etime]').attr('value', '${enjoy.etime}');
		...
		<div class="right_container">
			<div class="right_main">
				...
				<div class="insert_content">
					<form action="/mr/updateEnjoy.do" class="content_form" method="post" name="insert" enctype="multipart/form-data">
						<div class="left_box">
							<div class="small_box">
								<div>카테고리</div>
							...
							<div class="small_box">
								<div>부대시설명</div>
								<input type="text" name="etitle" class="data" required="required">
							</div>
							<div class="small_box">
								<div>한줄소개</div>
								<input type="text" name="etext" class="data" required="required">
							</div>
							<div class="small_box">
								<div>전화번호</div>
								<input type="text" name="ephone" class="data" required="required">
							</div>
							<div class="small_box">
								<div>위치</div>
								<input type="text" name="elocation" class="data" required="required">
							</div>
							<div class="small_box">
								<div>가격</div>
								<input type="text" name="eprice" class="data" required="required">
							</div>
							<div class="small_box">
								<div>영업시간</div>
								<input type="text" name="etime" class="data" required="required">
							</div>
						</div>
						<div class="right_box">
							<div class="small_box">
						...
						<div class="big_box">
							<textarea id="summernote" name="einfo" class="data" style="display: none;" required="required"></textarea>
						</div>
...
<script>
	...
	function showUploadImage(uploadResultArr) {
		...
		str += "<img src='/mr/display1.do?fileName=" + fileCallPath +"'>";
