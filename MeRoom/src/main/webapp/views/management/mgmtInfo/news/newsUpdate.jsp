...
function setValue() {
	$('input[name=neTitle]').attr('value', '${news.neTitle}');
	$('input[name=neSubtitle]').attr('value', '${news.neSubtitle}');
	$('#summernote').val('${news.neContent}');
}
</script>
<style>
* {
		...
		<div class="right_container">
			<div class="right_main">
				...
				<div class="insert_content">
					<form action="/mr/updateNews.do" class="content_form" method="post" name="insert" enctype="multipart/form-data">
						<div class="left_box">
							<div class="small_box">
								<div>제목</div>
								<input type="text" name="neTitle" class="data" >
							</div>
							<div class="small_box">
								<div>부제목</div>
								<input type="text" name="neSubtitle" class="data" >
							</div>
							<div class="small_box">
								<div>썸네일</div>
						...
						<div class="big_box">
							<textarea id="summernote" name="neContent" class="data" style="display: none;" ></textarea>
						</div>
