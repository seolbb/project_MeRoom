...
function back() {
	location.href="/mr/getNewsList.do"
}
		...
		<div class="right_container">
			<div class="right_main">
				...
				<div class="insert_content">
					<form action="/mr/insertNews.do" class="content_form" method="post" name="insert" enctype="multipart/form-data">
						<div class="left_box">
							<div class="small_box">
								<div>제목</div>
								<input type="text" name="neTitle" class="data" required="required">
							</div>
							<div class="small_box">
								<div>부제목</div>
								<input type="text" name="neSubtitle" class="data" required="required">
							</div>
							<div class="small_box">
								<div>썸네일</div>
						...
						<div class="big_box">
							<textarea id="summernote" name="neContent" class="data" style="display: none;" required="required"></textarea>
						</div>
...
<script>
	$("input[type='file']").on("change", function(e) {
		...
		$.ajax({
			url: "/mr/uploadAjaxPOST.do", // 서버로 요청보낼 url
	...
	function showUploadImage(uploadResultArr) {
		...
		str += "<img src='/mr/screenplay.do?fileName=" + fileCallPath +"'>";
