...
function back() {
	location.href="/mr/getEventListAdmin.do"
}
		...
		<div class="right_container">
			<div class="right_main">
				...
				<div class="insert_content">
					<form action="/mr/insertEvent.do" class="content_form" method="post" name="insert" enctype="multipart/form-data">
						<div class="left_box">
							<div class="small_box">
								<div>제목</div>
								<input type="text" name="evTitle" class="data" required="required">
							</div>
							<div class="small_box">
								<div>부제목</div>
								<input type="text" name="evSubtitle" class="data" required="required">
							</div>
							<div class="small_box">
								<div>썸네일</div>
								<input type="file" name="uploadFile" class="data" multiple="multiple" required="required">
							</div>
						</div>
						<div class="right_box">
							<div class="small_box">
						...
						<div class="big_box">
							<textarea id="summernote" name="evContent" class="data" style="display: none;" required="required"></textarea>
						</div>
...
<script>
	$("input[type='file']").on("change", function(e) {
		...
		$.ajax({
			url: "/mr/AjaxAction.do", // 서버로 요청보낼 url
	...
	function showUploadImage(uploadResultArr) {
		...
		str += "<img src='/mr/screenoutput.do?fileName=" + fileCallPath +"'>";
