		...
		<div class="right_container">
			<div class="right_main">
				...
				<div class="insert_content">
					<form action="/mr/updateEvent.do" class="content_form" method="post" name="insert" enctype="multipart/form-data">
						<div class="left_box">
							<div class="small_box">
								<div>제목</div>
								<input type="text" name="evTitle" class="data" >
							</div>
							<div class="small_box">
								<div>부제목</div>
								<input type="text" name="evSubtitle" class="data" >
							</div>
							<div class="small_box">
								<div>썸네일</div>
						...
						<div class="big_box">
							<textarea id="summernote" name="evContent" class="data" style="display: none;" ></textarea>
						</div>
...
<script>
	$("input[type='file']").on("change", function(e) {
		...
		$.ajax({
			url: "/mr/uploadAjaxAction.do", // 서버로 요청보낼 url
