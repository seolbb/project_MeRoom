		...
		<div class="right_container">
			<div class="right_main">
				...
				<div class="insert_content">
					<form action="/mr/insertPromotion.do" class="content_form" method="post" name="insert" enctype="multipart/form-data">
						<div class="left_box">
							<div class="small_box">
								<div>제목</div>
								<input type="text" name="prTitle" class="data" required="required">
							</div>
							<div class="small_box">
								<div>부제목</div>
								<input type="text" name="prSubtitle" class="data" required="required">
							</div>
							<div class="small_box">
								<div>썸네일</div>
						...
						<div class="big_box">
							<textarea id="summernote" name="prContent" class="data" style="display: none;" required="required"></textarea>
						</div>
