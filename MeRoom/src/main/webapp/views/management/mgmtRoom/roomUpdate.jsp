   ...
   function deleteImageAction(index) {            
	...
	$(function(){
		...
		$(strlet).each(function(i){
			...
			dpHtml += "<img width='170px'; src='http://localhost:8080/mr/images/uploadFiles/"+strlet[i]+"'>";
		});
...
function setValue() {
	$('input[name=rmNumber]').attr('value', '${roomOne.rmNumber}');
	$("select option[value='${roomOne.rmKind}']").attr('selected', true);
	$('input[name=rmArea]').attr('value', '${roomOne.rmArea}');
	$('input[name=rmPrice]').attr('value', '${roomOne.rmPrice}');
	var str = '${roomOne.rmInfo}';
	var str2 = str.replaceAll	("</li><li>", "&#10;");
	$('textarea[name=rmInfo]').html(str2);
}
</script>
<style>
* {
		...
		<div class="right_container">
			<div class="right_main">
				...
				<div class="insert_content">
					<form action="/mr/roomUpdate.do" class="content_form" method="post" name="insert" enctype="multipart/form-data">
						<div class="right_box">
							<div class="small_box">
