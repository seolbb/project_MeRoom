	...
	<div class="main_container">
		...
		<div class="right_container">
			...
			<div class="news_searchbox">
				<form id="search_form" action="/mr/reserList.do" method="post">
					<div class="form_shortbox">
						<input type="text" name="rIdx" class="form_shorttext" placeholder="예약번호">
					</div>
					<div class="form_shortbox">
						<input type="text" name="memberId" class="form_shorttext" placeholder="회원아이디">
					</div>
					<div class="buttonbox">
						<input type="submit" value="조회">
						<input type="reset" value="전체조회" onclick="search_all();">
						<input type="button" value="예약등록" onclick="javascript:$('.odc_inner').show();">
					</div>
				</form>
			</div>
			<div class="news_list">
				...
				<colgroup>
					...
					<c:if test="${not empty reserList}">
						<c:forEach var="reserOne" items="${reserList }">
						<tr>
							<td>${reserOne.rIdx}</td>
							<td>${reserOne.rmNumber}</td>
							<td>${reserOne.memberId}</td>
							<td>${reserOne.startDate}</td>
							<td>${reserOne.endDate}</td>
							<td>${reserOne.area}</td>
						</tr>
						</c:forEach>
					</c:if>
			...
			<div class="odc_inner" id="odc_info_i">
				<div class="odc_infobox">
					...
					<div class="infobox_content" id="infobox_print">
						<form id="search_form" action="/mr/adminReserInsert.do" method="post">
							<div class="form_shortbox">
								<input type="text" name="rmNumber" class="form_shorttext" placeholder="객실번호">
							</div>
							<div class="form_shortbox">
								<input type="text" name="memberId" class="form_shorttext" placeholder="회원아이디">
							</div>
							<div class="form_shortbox">
								<input type="text" name="aplctDate" class="form_shorttext" placeholder="예약일">
							</div>
							<div class="form_shortbox">
								<input type="text" name="startDate" class="form_shorttext" placeholder="입실일">
							</div>
							<div class="form_shortbox">
								<input type="text" name="endDate" class="form_shorttext" placeholder="퇴실일">
							</div>
							<div class="form_shortbox">
								<input type="text" name="area" class="form_shorttext" placeholder="인원">
							</div>
							<div class="buttonbox">
								<input type="submit" value="등록">
								<input type="reset" value="초기화">
								<input type="button" value="취소" onclick="javascript:$('.odc_inner').hide();">
							</div>
						</form>
					</div>
				</div>
