...
<body>
	<div class="mainphoto">
		<img alt="enjoy" src="img/background2.jpg">
	</div>
	...
	<div class="main">
		<div id="section" class="section_list">
			...
			<c:if test="${not empty entertains }">
				<c:forEach var="enjoy" items="${entertains }" varStatus="status">
