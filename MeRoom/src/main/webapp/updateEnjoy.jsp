...
<body>
	...
	<h2 style="text-align: center;">부대시설 수정</h2>

	<div style="width: 60%; margin: auto;">
		<form method="post" action="updateEnjoy.do">

			<div class="form-group">
				<label for="label">카테고리</label> <select name="ecategory"
					value="${enjoy.ecategory }">
			...
			<div class="form-group">
				<label for="label">부대시설명</label> <input type="text"
					class="form-control" id="label" name="etitle"
					value="${enjoy.etitle }">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<textarea value="${enjoy.einfo }" id="summernote" name="einfo" ></textarea>
			</div>
...
$("input[type='file']").on("change", function(e) { 
		...
		$.ajax({ 
			url: "uploadAjaxAction1.do", // 서버로 요청보낼 url 
