...
<script>
	...
	function uploadSummernoteImageFile(file, editor) {
		...
		$.ajax({
			data : data,
			type : "POST",
			url : "uploadFile.do",    //따로 컨트롤러 안에 추가해야됨
			contentType : false,
...
<body>
	...
	<br>
	<br>
	<form action="updatePromotion.do"  method="post" enctype="multipart/form-data"><div style="width: 60%; margin: auto;">
	
	
	<div class="form"><label for="label">제목</label><input type="text" name="prTitle" id="label" class="form-control"></div>

	<div class="form"><label for="label">부제목</label><input type="text" name="prSubtitle" id="label" class="form-control" ></div>
	...
	<div class="form"><label for="label">내용</label><textarea id="summernote" name="prContent"></textarea></div>
    ...
    <input type="submit" value="수정하기">
 	 ...
 	 <p>
			<a href="promotionwrite.jsp">새글등록</a>
			<a href="deletePromotion.do?prIdx=${promotion.prIdx }">글삭제</a>
			<a href="getPromotionList.do">글목록</a>
		</p>
 	 <br>
...
<script>
	$("input[type='file']").on("change", function(e) {
		...
		$.ajax({
			url: "uploadAjax.do", // 서버로 요청보낼 url
	...
	function showUploadImage(uploadResultArr) {
		...
		str += "<img src='pictureplay.do?fileName=" + fileCallPath +"'>";
