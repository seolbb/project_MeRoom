...
<body>
	<div class="mainphoto">
		<div class=maintitle>PLACE</div>
		<img alt="enjoy" src="img/skysky.jpg">
	</div>
	<div class="center">
		<h1>tourist[:여행]</h1>
		<h3>여행에 빠지다</h3>
	...
	<div class="mapsize" >
		...
		<div id="detail">
			<div class="container">
			  <img src="img/sungsan3.jpg" alt="성산" style="width:590px; height:500px;">
			  <div class="content">
			    <p> 힘든 일상에 지친 나를 위한 쉼을 가지기 좋은곳 미룸</p>
			    <p> 미룸에서 추천하는 다양한 관광지를 만나보세요. </p>
...
// 					dispHtml += "</li></ul>";
					...
					let dispHtml = "";
					dispHtml += "<div class='container'>";
					dispHtml += "<img style='width:590px; height:500px;' src='/upload/" + data.pfilepath + "'>";
					dispHtml += "<div class='content'>";
					dispHtml += "<h3>" + data.ptitle + "</h3>"; 
					dispHtml += "<p>" + "운영시간 : " + data.ptime + "</p>";
					dispHtml += "<p>" + "전화번호 : " + data.pphone + "</p>";
					dispHtml += "<p>" + "위      치 : " + data.plocation + "</p>";
					dispHtml += "</div>";
					dispHtml += "</div>";
...
// 					$("#detail").html(dispHtml);
					...
					dispHtml += "<img style='width:590px; height:500px;' src='/upload/" + data.pfilepath + "'>";
					dispHtml += "<div class='content'>";
					dispHtml += "<h3 style='font-weight: 500;'>" + data.ptitle + "</h3>"; 
					dispHtml += "<p>" + "운영시간 : " + data.ptime + "</p>";
					dispHtml += "<p>" + "전화번호 : " + data.pphone + "</p>";
					dispHtml += "<p>" + "위      치 : " + data.plocation + "</p>";
					dispHtml += "</div>";
