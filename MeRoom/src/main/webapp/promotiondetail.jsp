...
<body>
	...
	<br>
	<div class="top_bar">
		<h3>${promotion.prTitle }</h3>
		<p> ${promotion.prRegdate }</p>	
	</div>
	<br>
	<br>
	<br>
	...
	<p class="promotionContent"> ${promotion.prContent }</p>
	</div>
	<br>
	<br>
	<br>
		...
		<br>
		<div class="row">
  	 	 <a href="getPromotionList.do"><input type="submit" value="LIST"></a>
  		</div>
