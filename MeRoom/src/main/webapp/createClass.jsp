...
<div style="width: 60%; margin: auto;">
    <form method="post" action="insertClass.do">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="label" name="oName">
      </div>
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="time" class="form-control" id="label" name="oTime">
        <div id="datepicker"></div>
      </div>
      <div class="form-group">
        <label for="label">수강장소</label>
        <input type="text" class="form-control" id="label" name="oLocation">
      </div>
      <div class="form-group">
        <label for="label">수강가격</label>
        <input type="number" class="form-control" id="label" name="oPrice">
      </div>
      <div class="form-group">
        <label for="label">수강인원</label>
        <input type="number" class="form-control" id="label" name="oCnt">
      </div>
	  <div class="form-group">
