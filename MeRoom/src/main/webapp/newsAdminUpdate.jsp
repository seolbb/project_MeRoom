...
<body>
	...
	<br>
	<br>
	<form action="updateNews.do"  method="post" enctype="multipart/form-data"><div style="width: 60%; margin: auto;">
    ...
    <input type="submit" value="수정하기">
 	 ...
 	 <p>
			<a href="newswrite.jsp">새글등록</a>
			<a href="deleteNews.do?neIdx=${news.neIdx }">글삭제</a>
			<a href="getNewsList.do">글목록</a>
		</p>
 	 <br>
