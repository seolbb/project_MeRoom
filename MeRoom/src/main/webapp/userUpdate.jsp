...
<script>
	...
	$(function(){
		...
		console.log(address.substr(address.indexOf(",")+1, address.length));
		$('input[name="address_k"]').val(address.substr(0, address.indexOf(",")));
		$('input[name="addressDetail"]').val(address.substr(address.indexOf(",")+1, address.length));
...
<%@ include file="mainheader.jsp" %>
 ...
 <div id="wrap">
	...
	<form id="form1" action="modifyUser.do" method="post" >
		<div class="h2-Text">
		...
		<table class="tb_main">
			...
			<tbody>
				...
				<tr class="social">
					...
					<td>
					<button type="button" name="password" id="pwd" class="adCheck"
						onclick="location.href='updatePw.jsp'">비밀번호변경</button>
					</td>
				</tr>
				 ...
				 <tr>
                  ...
                  <tr>
                    ...
                    <td>
                        <input type="text" name="nickname" class="input--text name" maxlength="20" value=${vo.nickname } required>
                    </td>
                 </tr>
				...
				<tr>
				 ...
				 <tr>
                    ...
                    <td>
                    ${vo.email }
                        <input type="button" id="emailCheck" class="adCheck" value="메일변경하기"
                        onclick="location.href='updateMail2.jsp'">
                    </td>
                 </tr>
			...
			<div class="btngroups">
				 <button type="submit" class="btn btn-success" id="btnclick" >수정하기</button>
