		...
		<form>
			<div id = "panel" class="panel panel-default">
				...
				<div class="panel-body">
					...
					<input type="text" id="userId" class="input form-control" name="userId" placeholder="ID"> 
					...
					<br>
					 ...
					 <div class="inputag">
					   <input type="text"  id="idMail" name="email_id" class="input form-control email"  placeholder="EMAIL">
						...
						<input type="text" id="inputMail" name="email_domain" class="input form-control email" required>
					 </div>
					 <div class="button-box">
		           	 	<button type="button" id="findbtn1" class="btn btn-default btn01">찾기</button>
		           		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<div id="category2" class="tabcontent">
						<input type="text" id="userId2" class="input form-control" name="userId" placeholder="ID"> 
						<input type="text" id="nameId2" class="input form-control" name="name" placeholder="이름">
					    <br>
					    <div class="inputag">
					            <input type="text" id="phone1" name="phone1" 
					                class="input form-control phone" maxlength="3" required
					                placeholder="000"> 
					                <div style="margin: 7px 10px 10px 10px;">-</div>
					            <input type="text" id="phone2" name="phone2" 
					                class="input form-control phone" maxlength="4" required
					                placeholder="0000"> 
					                <div style="margin: 7px 10px 10px 10px;">-</div>
